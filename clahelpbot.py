...
def write_photo(message):
    cur.execute("INSERT INTO public.memebase (message_id, from_user, date, chat) VALUES (%s, %s, %s, %s);", (message.message_id, str(message.from_user), str(message.date), int(message.chat)))
