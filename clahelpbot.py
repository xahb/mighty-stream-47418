...
def write_photo(message):
    cur.execute("INSERT INTO public.memebase (message_id, from_user_id, from_user_first_name, date, chat_id) VALUES (%s, %s, %s, %s);", (message.message_id, message.from_user.id, message.from_user.first_name, str(message.date), message.chat.id))
